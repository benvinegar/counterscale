...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/Users/benvinegar/Projects/tallyho-workers/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/Users/benvinegar/Projects/tallyho-workers/.wrangler/tmp/bundle-vdIWus/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/Users/benvinegar/Projects/tallyho-workers/.wrangler/tmp/bundle-vdIWus/middleware-insertion-facade.js";
